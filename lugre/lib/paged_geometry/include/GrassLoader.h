...
-------------------------------------------------------------------------------------
changes HeightFunction Callback interface for lugre binding
-------------------------------------------------------------------------------------*/
...
class GrassLoader: public PageLoader, public Lugre::cSmartPointable
{
public:
...
*/
class GrassLayer : public Lugre::cSmartPointable
{
public:
