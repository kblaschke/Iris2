//===============================================================================================================
//Example 5 - Dynamic Trees
//---------------------------------------------------------------------------------------------------------------
//	This example demonstrates the use of TreeLoader2D to dynamically add/remove trees.
//  Instructions: Move around with arrow/WASD keys. Left mouse button adds trees, right mouse button deletes trees.
...
void World::load()
{
	...
	treeLoader = new TreeLoader2D(trees, TBounds(0, 0, 1500, 1500));
	...
	//Randomly place 2000 copies of the tree on the terrain.
	//More will be added later by the user (see World::processInput())
