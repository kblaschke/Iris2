...
namespace Caelum
{
	...
	public:
		...
		/// LUGRE update rate
		inline void setUpdateTimeout(Ogre::Real updateTimeout) { mUpdateTimeout = updateTimeout; }
		inline Ogre::Real getUpdateTimeout() { return mUpdateTimeout; }
